...
const ChildId: React.FC<ChildIdProps> = ({match}) => (
  <div>
    <h3>ID: {match.params.id}</h3>
  </div>
);

const ComponentParams: React.FC = () => (
  <div>
    <ul>
...
## TypeScript Support
This package now includes full TypeScript support with type definitions.

## React 19 Compatibility
This package has been updated to be compatible with React 19 and the latest React Router v6.
