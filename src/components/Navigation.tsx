...
const Navigation = () => {
  ...
  return (
    <motion.header 
      className="fixed top-0 left-0 right-0 w-full border-b border-accent/20 bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/70 shadow-lg"
      style={{ zIndex: 9999 }}
      initial={{ y: 0 }}
